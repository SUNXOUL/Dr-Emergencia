        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fecha = table.Column<DateTime>(type: "TEXT", nullable: true),
                    M_Consulta = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    Ex_Orina = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    E_Inferiores = table.Column<string>(type: "TEXT", nullable: true),
                    E_Superiores = table.Column<string>(type: "TEXT", nullable: true),
                    Diagnostico = table.Column<string>(type: "TEXT", nullable: true),
                    Hemogramas = table.Column<int>(type: "INTEGER", nullable: true),
                    Ex_Orina = table.Column<int>(type: "INTEGER", nullable: true),
                    Glisemia = table.Column<int>(type: "INTEGER", nullable: true),
